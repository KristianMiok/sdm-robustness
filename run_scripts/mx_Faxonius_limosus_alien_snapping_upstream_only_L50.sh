#!/bin/bash
#SBATCH --job-name=mx_Faxonius_limosus_alien_snapping_upstream_only_L50
...
python scripts/run_task5_entity.py \
  ...
  --output-dir results/task5_execution/Faxonius_limosus_alien_maxent_snapping_upstream_only_L50 \
  --skip-benchmark \
  --algorithms maxent \
  --axes snapping \
