#!/bin/bash
#SBATCH --job-name=t3ext
#SBATCH --partition=cpu
#SBATCH --cpus-per-task=8
#SBATCH --mem-per-cpu=1800M
#SBATCH --time=24:00:00
#SBATCH --array=0-25%10
#SBATCH --output=logs/t3ext_%A_%a.out
#SBATCH --error=logs/t3ext_%A_%a.err
set -uo pipefail
...
python scripts/revision/t3_displacement.py --entity "$ENT" --alg "$ALG" --reps 15 --dists 1000 2000 --out-suffix ext
