#!/bin/bash
#SBATCH --job-name=mx_Pontastacus_leptodactylus_pooled_lowacc_local_only_L10
...
python scripts/run_task5_entity.py \
  ...
  --output-dir results/task5_execution/Pontastacus_leptodactylus_pooled_maxent_lowacc_local_only_L10 \
  --skip-benchmark \
  --algorithms maxent \
  --axes lowacc \
  --tracks local_only \
