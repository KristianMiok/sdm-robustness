#!/bin/bash
#SBATCH --job-name=mx_Austropotamobius_fulcisianus_pooled_lowacc_local_only_L0
...
python scripts/run_task5_entity.py \
  ...
  --output-dir results/task5_execution/Austropotamobius_fulcisianus_pooled_maxent_lowacc_local_only_L0 \
  --skip-benchmark \
  --algorithms maxent \
  --axes lowacc \
  --tracks local_only \
