#!/bin/bash
#SBATCH --job-name=mx_Pacifastacus_leniusculus_alien_snapping_combined_L10
...
python scripts/run_task5_entity.py \
  ...
  --output-dir results/task5_execution/Pacifastacus_leniusculus_alien_maxent_snapping_combined_L10 \
  --skip-benchmark \
  --algorithms maxent \
  --axes snapping \
  --tracks combined \
