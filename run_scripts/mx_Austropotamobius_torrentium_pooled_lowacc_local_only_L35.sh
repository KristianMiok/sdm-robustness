#!/bin/bash
#SBATCH --job-name=mx_Austropotamobius_torrentium_pooled_lowacc_local_only_L35
...
python scripts/run_task5_entity.py \
  ...
  --output-dir results/task5_execution/Austropotamobius_torrentium_pooled_maxent_lowacc_local_only_L35 \
  --skip-benchmark \
  --algorithms maxent \
  --axes lowacc \
  --tracks local_only \
