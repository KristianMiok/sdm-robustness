#!/bin/bash
#SBATCH --job-name=mx_Faxonius_limosus_alien_snapping_local_only_L5
...
python scripts/run_task5_entity.py \
  ...
  --output-dir results/task5_execution/Faxonius_limosus_alien_maxent_snapping_local_only_L5 \
  --skip-benchmark \
  --algorithms maxent \
  --axes snapping \
  --tracks local_only \
