#!/bin/bash
#SBATCH --job-name=mx_Austropotamobius_torrentium_pooled_snapping_local_only_L35
...
python scripts/run_task5_entity.py \
  ...
  --output-dir results/task5_execution/Austropotamobius_torrentium_pooled_maxent_snapping_local_only_L35 \
  --skip-benchmark \
  --algorithms maxent \
  --axes snapping \
  --tracks local_only \
