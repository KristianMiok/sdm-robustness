#!/bin/bash
#SBATCH --job-name=mx_Austropotamobius_fulcisianus_pooled_snapping_upstream_only_L50
...
python scripts/run_task5_entity.py \
  ...
  --output-dir results/task5_execution/Austropotamobius_fulcisianus_pooled_maxent_snapping_upstream_only_L50 \
  --skip-benchmark \
  --algorithms maxent \
  --axes snapping \
