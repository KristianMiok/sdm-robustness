#!/bin/bash
#SBATCH --job-name=mx_Procambarus_clarkii_native_lowacc_local_only_L0
...
python scripts/run_task5_entity.py \
  ...
  --output-dir results/task5_execution/Procambarus_clarkii_native_maxent_lowacc_local_only_L0 \
  --skip-benchmark \
  --algorithms maxent \
  --axes lowacc \
  --tracks local_only \
