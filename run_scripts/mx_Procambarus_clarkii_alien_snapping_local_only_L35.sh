#!/bin/bash
#SBATCH --job-name=mx_Procambarus_clarkii_alien_snapping_local_only_L35
...
python scripts/run_task5_entity.py \
  ...
  --output-dir results/task5_execution/Procambarus_clarkii_alien_maxent_snapping_local_only_L35 \
  --skip-benchmark \
  --algorithms maxent \
  --axes snapping \
  --tracks local_only \
