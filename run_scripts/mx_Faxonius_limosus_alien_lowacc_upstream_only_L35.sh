#!/bin/bash
#SBATCH --job-name=mx_Faxonius_limosus_alien_lowacc_upstream_only_L35
...
python scripts/run_task5_entity.py \
  ...
  --output-dir results/task5_execution/Faxonius_limosus_alien_maxent_lowacc_upstream_only_L35 \
  --skip-benchmark \
  --algorithms maxent \
  --axes lowacc \
