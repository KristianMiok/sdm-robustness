#!/bin/bash
#SBATCH --job-name=mx_Lacunicambarus_diogenes_upstream_only_L5
...
python scripts/run_task5_entity.py \
  ...
  --output-dir results/task5_execution/Lacunicambarus_diogenes_maxent_snapping_upstream_only_L5 \
  --skip-benchmark \
  --algorithms maxent \
  --axes snapping \
